clear
cd "Q:\DATA\AISU\Elizabeth\Korea\boxplots\bank_specific\KEB"
...
capture egen KEB=mean(`x'), by(time num)
replace KEB=. if num!=3
}
rename KEB x_KEB
sort t type
...
xla(1 "2015" 13 "2016" 25 "2017" 37 "2018") ytitle(`var', axis(1)) || ///
line KEB date, lcolor(yellow) lwidth(.6) xsize(12) ysize(3) plotregion(fcolor(white)) graphregion(fcolor(white)) legend(order(1 "Nationwide" 2 "Regional" 3 "Specialized" 10 "KEB"))
...
rspike x_upq x_p95 date if type=="Regional", pstyle(p2) || ///
rspike x_upq x_p95 date if type=="Specialized", pstyle(p3) ///
xla(4 "2015" 16 "2016" 28 "2017" 40 "2018") ytitle(cet1_rwa, axis(1)) || ///
line KEB date, lcolor(yellow) lwidth(.6) xsize(12) ysize(3) plotregion(fcolor(white)) graphregion(fcolor(white)) legend(order(1 "Nationwide" 2 "Regional" 3 "Specialized" 10 "KEB"))
...
rspike x_upq x_p95 date if type=="Regional", pstyle(p2) || ///
rspike x_upq x_p95 date if type=="Specialized", pstyle(p3) ///
xla(1 "2015" 13 "2016" 25 "2017" 37 "2018" 49) ytitle(llp_loans, axis(1)) || ///
line KEB date, lcolor(yellow) lwidth(.6) xsize(12) ysize(3) plotregion(fcolor(white)) graphregion(fcolor(white)) legend(order(1 "Nationwide" 2 "Regional" 3 "Specialized" 10 "KEB"))
...
rspike x_upq x_p95 date if type=="Regional", pstyle(p2) || ///
rspike x_upq x_p95 date if type=="Specialized", pstyle(p3) ///
 xla(1 "2015" 9 "2016" 17 "2017" 25 "2018") ytitle(`var', axis(1)) || ///
line KEB date, lcolor(yellow) lwidth(.6) xsize(12) ysize(3) plotregion(fcolor(white)) graphregion(fcolor(white)) legend(order(1 "Nationwide" 2 "Regional" 10 "KEB"))
